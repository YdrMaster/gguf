...
impl SplitArgs {
    pub fn split(self) {
        ...
        let tensors = ctx_gguf
            .tensors
            .iter()
            .map(move |t| (t, ctx_gguf.data))
...
mod tests {
    ...
    #[test]
    fn it_works() {
        let input = PathBuf::from("/home/qinyiqun/gguf/xtask/src/h2o-danube3-500m-chat-F16.gguf");
        let output = Some("/home/qinyiqun/gguf/xtask/src/test/rust/rust".to_string());
